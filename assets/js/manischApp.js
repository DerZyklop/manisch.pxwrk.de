...
(function() {
  var App, AppView, Item, ItemDetailView, ItemView, List, ListView, pxwrkHelpersForViews,
  ...
  */
  ...
  ItemView = (function(_super) {
    ...
    ItemView.prototype.itemDetailView = new ItemDetailView;
  ...
  AppView = (function(_super) {
    ...
    AppView.prototype.initialize = function() {
      ...
      jQuery('.sort').on('click', function(event) {
        ...
        return _this.list.getItemsByCategory(categoryName);
      });
