...
(function() {
  var AppView, Item, ItemDetailView, ItemView, List, ListView, RandomView, Router, app, pxwrkHelpersForViews, router, translations,
  ...
  */
  ...
  ItemDetailView = (function(_super) {
    ...
    ItemDetailView.prototype.initialize = function() {
      var contentDiv, insights, item, url;
      _.bindAll(this);
  ...
  */
  ...
  /* --------------------------------------------
       Begin RandomView.coffee
  --------------------------------------------
  */


  RandomView = (function(_super) {

    __extends(RandomView, _super);

    function RandomView() {
      return RandomView.__super__.constructor.apply(this, arguments);
    }

    RandomView.prototype.el = '#list-view ul';

    RandomView.prototype.visibleItems = new List;

    RandomView.prototype.showItemDetail = function(params) {
    ...
    RandomView.prototype.appendItem = function(item) {
      var itemView;
      itemView = new ItemView({
        model: item,
        className: this.getClassName(item, item.collection.length)
    ...
    RandomView.prototype.deactivateInfo = function() {
      var el;
      el = jQuery('#bottom-list-info');
      if (!el.hasClass('inactive')) {
        return el.addClass('inactive');
    ...
    RandomView.prototype.render = function() {
      this.functionLog('render()');
      return this.deactivateInfo();
    };

    RandomView.prototype.unrender = function() {
      return jQuery(this.el).html('');
    };
  ...
  */
  ...
  AppView = (function(_super) {
    ...
    AppView.prototype.randomView = new RandomView;
  ...
  */
  ...
  Router = (function(_super) {
    ...
    Router.prototype.showRandomItems = function() {
      ...
      return app.randomView.render();
    };

    Router.prototype.showItem = function(category, search, itemId) {
      console.log('showItem');
      this.showFilteredList(category, search);
      return app.showItemDetail({
        category: category,
        search: search,
        id: itemId
      });
