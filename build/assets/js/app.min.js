/*! manisch-german-dict - v0.4.8 - 2013-08-21 */(function(a, b) {
    function cy(a) {
    ...
    function cu(a) {
        if (!cj[a]) {
            ...
            d.remove(), ("none" === e || "" === e) && (ck || (ck = c.createElement("iframe"), 
            ck.frameBorder = ck.width = ck.height = 0), b.appendChild(ck), cl && ck.createElement || (cl = (ck.contentWindow || ck.contentDocument).document, 
    ...
    function bY(a) {
        return function(b, c) {
            ...
            j = /^\+/.test(h), j && (h = h.substr(1) || "*"), i = a[h] = a[h] || [], i[j ? "unshift" : "push"](c);
        };
    }
    function bB(a, b, c) {
        var d = "width" === b ? a.offsetWidth : a.offsetHeight, e = "width" === b ? 1 : 0, g = 4;
        if (d > 0) {
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function() {
        ...
        return e.fn = e.prototype = {
            ...
            init: function(a, d, f) {
                ...
                if ("body" === a && !d && c.body) return this.context = c, this[0] = c.body, this.selector = a, 
                this.length = 1, this;
                if ("string" == typeof a) {
                    if (g = "<" !== a.charAt(0) || ">" !== a.charAt(a.length - 1) || a.length < 3 ? i.exec(a) : [ null, a, null ], 
                    g && (g[1] || !d)) {
                        if (g[1]) return d = d instanceof e ? d[0] : d, k = d ? d.ownerDocument || d : c, 
                        j = m.exec(a), j ? e.isPlainObject(d) ? (a = [ c.createElement(j[1]) ], e.fn.attr.call(a, d, !0)) : a = [ k.createElement(j[1]) ] : (j = e.buildFragment([ g[1] ], [ k ]), 
                        a = (j.cacheable ? e.clone(j.fragment) : j.fragment).childNodes), e.merge(this, a);
                ...
                this.context = a.context), e.makeArray(a, this));
            },
            selector: "",
            jquery: "1.7.2",
            length: 0,
            ...
            pushStack: function(a, b, c) {
                ...
                return e.isArray(a) ? E.apply(d, a) : e.merge(d, a), d.prevObject = this, d.context = this.context, 
            ...
            for ("boolean" == typeof i && (l = i, i = arguments[1] || {}, j = 2), "object" != typeof i && !e.isFunction(i) && (i = {}), 
            k === j && (i = this, --j); k > j; j++) if (null != (a = arguments[j])) for (c in a) d = i[c], 
            f = a[c], i !== f && (l && f && (e.isPlainObject(f) || (g = e.isArray(f))) ? (g ? (g = !1, 
            ...
            parseJSON: function(b) {
                return "string" == typeof b && b ? (b = e.trim(b), a.JSON && a.JSON.parse ? a.JSON.parse(b) : n.test(b.replace(o, "@").replace(p, "]").replace(q, "")) ? new Function("return " + b)() : (e.error("Invalid JSON: " + b), 
                void 0)) : null;
            },
            parseXML: function(c) {
    ...
    f.Callbacks = function(a) {
        a = a ? g[a] || h(a) : {};
        var e, i, j, k, l, m, c = [], d = [], n = function(b) {
            var d, e, g, h;
            for (d = 0, e = b.length; e > d; d++) g = b[d], h = f.type(g), "array" === h ? n(g) : "function" === h && (!a.unique || !p.has(g)) && c.push(g);
        }, o = function(b, f) {
            for (f = f || [], e = !a.memory || [ b, f ], i = !0, j = !0, m = k || 0, k = 0, 
            l = c.length; c && l > m; m++) if (c[m].apply(b, f) === !1 && a.stopOnFalse) {
                e = !0;
                break;
            }
            ...
            remove: function() {
                if (c) for (var b = arguments, d = 0, e = b.length; e > d; d++) for (var f = 0; f < c.length && (b[d] !== c[f] || (j && l >= f && (l--, 
                m >= f && m--), c.splice(f--, 1), !a.unique)); f++) ;
                return this;
            },
            has: function(a) {
    ...
    f.extend({
        ...
        if (c.documentElement, p.setAttribute("className", "t"), p.innerHTML = "   <link/><table></table><a href='/a' style='top:1px;float:left;opacity:.55;'>a</a><input type='checkbox'/>", 
        d = p.getElementsByTagName("*"), e = p.getElementsByTagName("a")[0], !d || !d.length || !e) return {};
        ...
        b = {
            ...
            pixelMargin: !0
        }, f.boxModel = b.boxModel = "CSS1Compat" === c.compatMode, i.checked = !0, b.noCloneChecked = i.cloneNode(!0).checked, 
        ...
        j.removeChild(i), j.appendChild(p), p.attachEvent) for (n in {
            submit: 1,
            change: 1,
            focusin: 1
        }) m = "on" + n, o = m in p, o || (p.setAttribute(m, "return;"), o = "function" == typeof p[m]), 
        b[n + "Bubbles"] = o;
        return j.removeChild(p), j = g = h = p = i = null, f(function() {
            ...
            k = p.getElementsByTagName("td"), o = 0 === k[0].offsetHeight, k[0].style.display = "", 
            k[1].style.display = "none", b.reliableHiddenOffsets = o && 0 === k[0].offsetHeight, 
            a.getComputedStyle && (p.innerHTML = "", l = c.createElement("div"), l.style.width = "0", 
            l.style.marginRight = "0", p.style.width = "2px", p.appendChild(l), b.reliableMarginRight = 0 === (parseInt((a.getComputedStyle(l, null) || {
                marginRight: 0
            }).marginRight, 10) || 0)), "undefined" != typeof p.style.zoom && (p.innerHTML = "", 
            p.style.width = p.style.padding = "1px", p.style.border = 0, p.style.overflow = "hidden", 
            p.style.display = "inline", p.style.zoom = 1, b.inlineBlockNeedsLayout = 3 === p.offsetWidth, 
            p.style.display = "block", p.style.overflow = "visible", p.innerHTML = "<div style='width:5px;'></div>", 
            b.shrinkWrapBlocks = 3 !== p.offsetWidth), p.style.cssText = r + s, p.innerHTML = q, 
            ...
            }, g.style.position = "fixed", g.style.top = "20px", j.fixedPosition = 20 === g.offsetTop || 15 === g.offsetTop, 
            g.style.position = g.style.top = "", e.style.overflow = "hidden", e.style.position = "relative", 
            j.subtractsBorderForOverflowNotVisible = -5 === g.offsetTop, j.doesNotIncludeMarginInBodyOffset = u.offsetTop !== m, 
            a.getComputedStyle && (p.style.marginTop = "1%", b.pixelMargin = "1%" !== (a.getComputedStyle(p, null) || {
                marginTop: 0
            }).marginTop), "undefined" != typeof d.style.zoom && (d.style.zoom = 1), u.removeChild(d), 
    ...
    f.extend({
        ...
        data: function(a, c, d, e) {
            if (f.acceptData(a)) {
                ...
                o && !h[c] ? g.events : (k ? (i = h[c], null == i && (i = h[f.camelCase(c)])) : i = h, 
                i);
            }
        },
        ...
        data: function(a, c) {
            ...
            if (a === b) {
                if (this.length && (m = f.data(j), 1 === j.nodeType && !f._data(j, "parsedAttrs"))) {
                    for (g = j.attributes, i = g.length; i > k; k++) h = g[k].name, 0 === h.indexOf("data-") && (h = f.camelCase(h.substring(5)), 
                    l(j, h, m[h]));
            ...
            return "object" == typeof a ? this.each(function() {
                ...
                return c === b ? (m = this.triggerHandler("getData" + e, [ d[0] ]), m === b && j && (m = f.data(j, a), 
                m = l(j, a, m)), m === b && d[1] ? this.data(d[0]) : m) : (d[1] = c, this.each(function() {
                    var b = f(this);
        ...
        queue: function(a, b, c) {
            var d;
            return a ? (b = (b || "fx") + "queue", d = f._data(a, b), c && (!d || f.isArray(c) ? d = f._data(a, b, f.makeArray(c)) : d.push(c)), 
            d || []) : void 0;
        },
        ...
        promise: function(a, c) {
            ...
            for (var l, d = f.Deferred(), e = this, g = e.length, h = 1, i = a + "defer", j = a + "queue", k = a + "mark"; g--; ) (l = f.data(e[g], i, b, !0) || (f.data(e[g], j, b, !0) || f.data(e[g], k, b, !0)) && f.data(e[g], i, f.Callbacks("once memory"), !0)) && (h++, 
            l.add(m));
    ...
    f.fn.extend({
        ...
        addClass: function(a) {
            ...
            if (a && "string" == typeof a) for (b = a.split(p), c = 0, d = this.length; d > c; c++) if (e = this[c], 
        ...
        removeClass: function(a) {
            ...
            if (a && "string" == typeof a || a === b) for (c = (a || "").split(p), d = 0, e = this.length; e > d; d++) if (g = this[d], 
            1 === g.nodeType && g.className) if (a) {
        ...
        toggleClass: function(a, b) {
            ...
            return f.isFunction(a) ? this.each(function(c) {
                ...
                h[i ? "addClass" : "removeClass"](e); else ("undefined" === c || "boolean" === c) && (this.className && f._data(this, "__className__", this.className), 
        ...
        val: function(a) {
            ...
            })) : g ? (c = f.valHooks[g.type] || f.valHooks[g.nodeName.toLowerCase()], c && "get" in c && (d = c.get(g, "value")) !== b ? d : (d = g.value, 
            "string" == typeof d ? d.replace(q, "") : null == d ? "" : d)) : void 0;
        }
    }), f.extend({
        valHooks: {
            option: {
        ...
        attr: function(a, c, d, e) {
            ...
            return a && 3 !== j && 8 !== j && 2 !== j ? e && c in f.attrFn ? f(a)[c](d) : "undefined" == typeof a.getAttribute ? f.prop(a, c, d) : (i = 1 !== j || !f.isXMLDoc(a), 
            i && (c = c.toLowerCase(), h = f.attrHooks[c] || (u.test(c) ? x : w)), d !== b ? null === d ? (f.removeAttr(a, c), 
            void 0) : h && "set" in h && i && (g = h.set(a, d, c)) !== b ? g : (a.setAttribute(c, "" + d), 
            d) : h && "get" in h && i && null !== (g = h.get(a, c)) ? g : (g = a.getAttribute(c), 
            null === g ? b : g)) : void 0;
        },
        removeAttr: function(a, b) {
            var c, d, e, g, h, i = 0;
            if (b && 1 === a.nodeType) for (d = b.toLowerCase().split(p), g = d.length; g > i; i++) e = d[i], 
            e && (c = f.propFix[e] || e, h = u.test(e), h || f.attr(a, e, ""), a.removeAttribute(v ? e : c), 
            h && c in a && (a[c] = !1));
        },
        attrHooks: {
            type: {
        ...
        prop: function(a, c, d) {
            ...
            return a && 3 !== i && 8 !== i && 2 !== i ? (h = 1 !== i || !f.isXMLDoc(a), h && (c = f.propFix[c] || c, 
            g = f.propHooks[c]), d !== b ? g && "set" in g && (e = g.set(a, d, c)) !== b ? e : a[c] = d : g && "get" in g && null !== (e = g.get(a, c)) ? e : a[c]) : void 0;
        },
        propHooks: {
            tabIndex: {
                get: function(a) {
        ...
        set: function(a, b, c) {
            var d;
            return b === !1 ? f.removeAttr(a, c) : (d = f.propFix[c] || c, d in a && (a[d] = !0), 
    ...
    f.event = {
        add: function(a, c, d, e, g) {
            ...
            if (3 !== a.nodeType && 8 !== a.nodeType && c && d && (h = f._data(a))) {
                for (d.handler && (p = d, d = p.handler, g = p.selector), d.guid || (d.guid = f.guid++), 
                ...
                m = l[1], n = (l[2] || "").split(".").sort(), s = f.event.special[m] || {}, m = (g ? s.delegateType : s.bindType) || m, 
                s = f.event.special[m] || {}, o = f.extend({
                    ...
                    quick: g && G(g),
                    namespace: n.join(".")
                }, p), r = j[m], r || (r = j[m] = [], r.delegateCount = 0, s.setup && s.setup.call(a, e, n, i) !== !1 || (a.addEventListener ? a.addEventListener(m, i, !1) : a.attachEvent && a.attachEvent("on" + m, i))), 
        ...
        remove: function(a, b, c, d, e) {
            ...
            if (g && (o = g.events)) {
                for (b = f.trim(I(b || "")).split(" "), h = 0; h < b.length; h++) if (i = A.exec(b[h]) || [], 
                j = k = i[1], l = i[2], j) {
                    for (p = f.event.special[j] || {}, j = (d ? p.delegateType : p.bindType) || j, r = o[j] || [], 
                    m = r.length, l = l ? new RegExp("(^|\\.)" + l.split(".").sort().join("\\.(?:.*\\.)?") + "(\\.|$)") : null, 
                    n = 0; n < r.length; n++) s = r[n], !(!e && k !== s.origType || c && c.guid !== s.guid || l && !l.test(s.namespace) || d && d !== s.selector && ("**" !== d || !s.selector) || (r.splice(n--, 1), 
        ...
        trigger: function(c, d, e, g) {
            if (!e || 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                if (h.indexOf("!") >= 0 && (h = h.slice(0, -1), k = !0), h.indexOf(".") >= 0 && (i = h.split("."), 
                h = i.shift(), i.sort()), (!e || f.event.customEvent[h]) && !f.event.global[h]) return;
                ...
                o = h.indexOf(":") < 0 ? "on" + h : "", !e) {
                    j = f.cache;
                    for (l in j) j[l].events && j[l].events[h] && f.event.trigger(c, d, j[l].handle.elem, !0);
                    return;
                }
                if (c.result = b, c.target || (c.target = e), d = null != d ? f.makeArray(d) : [], 
                d.unshift(c), p = f.event.special[h] || {}, p.trigger && p.trigger.apply(e, d) === !1) return;
                if (r = [ [ e, p.bindType || h ] ], !g && !p.noBubble && !f.isWindow(e)) {
                    for (s = p.delegateType || h, m = E.test(s + h) ? e : e.parentNode, n = null; m; m = m.parentNode) r.push([ m, s ]), 
                    n = m;
                ...
                return c.type = h, !(g || c.isDefaultPrevented() || p._default && p._default.apply(e.ownerDocument, d) !== !1 || "click" === h && f.nodeName(e, "a") || !f.acceptData(e) || !o || !e[h] || ("focus" === h || "blur" === h) && 0 === c.target.offsetWidth || f.isWindow(e) || (n = e[o], 
        ...
        dispatch: function(c) {
            ...
            var k, l, m, n, o, p, q, r, s, t, d = (f._data(this, "events") || {})[c.type] || [], e = d.delegateCount, g = [].slice.call(arguments, 0), h = !c.exclusive && !c.namespace, i = f.event.special[c.type] || {}, j = [];
            if (g[0] = c, c.delegateTarget = this, !i.preDispatch || i.preDispatch.call(this, c) !== !1) {
                if (e && (!c.button || "click" !== c.type)) for (n = f(this), n.context = this.ownerDocument || this, 
                m = c.target; m != this; m = m.parentNode || this) if (m.disabled !== !0) {
                    for (p = {}, r = [], n[0] = m, k = 0; e > k; k++) s = d[k], t = s.selector, p[t] === b && (p[t] = s.quick ? H(m, s.quick) : n.is(t)), 
                    p[t] && r.push(s);
                    r.length && j.push({
                        elem: m,
                        matches: r
                ...
                for (d.length > e && j.push({
                    elem: this,
                    matches: d.slice(e)
                }), k = 0; k < j.length && !c.isPropagationStopped(); k++) for (q = j[k], c.currentTarget = q.elem, 
                l = 0; l < q.matches.length && !c.isImmediatePropagationStopped(); l++) s = q.matches[l], 
                (h || !c.namespace && !s.namespace || c.namespace_re && c.namespace_re.test(s.namespace)) && (c.data = s.data, 
        ...
        mouseHooks: {
            ...
            filter: function(a, d) {
                ...
                return null == a.pageX && null != d.clientX && (e = a.target.ownerDocument || c, 
        ...
        fix: function(a) {
            ...
            return a.target || (a.target = g.srcElement || c), 3 === a.target.nodeType && (a.target = a.target.parentNode), 
            a.metaKey === b && (a.metaKey = a.ctrlKey), h.filter ? h.filter(a, g) : a;
        },
        special: {
            ready: {
                setup: f.bindReady
        ...
        return this instanceof f.Event ? (a && a.type ? (this.originalEvent = a, this.type = a.type, 
        ...
        f.event.special[a] = {
            ...
            handle: function(a) {
                ...
                return e.selector, (!d || d !== c && !f.contains(c, d)) && (a.type = e.origType, 
                h = e.handler.apply(this, arguments), a.type = b), h;
            }
        };
        ...
        var m = function(b, d, e, f) {
            ...
            if (w.length > 1 && p.exec(b)) if (2 === w.length && o.relative[w[0]]) j = y(w[0] + w[1], d, f); else for (j = o.relative[w[0]] ? [ d ] : m(w.shift(), d); w.length; ) b = w.shift(), 
            o.relative[b] && (b += w.shift()), j = y(b, j, f); else if (!f && w.length > 1 && 9 === d.nodeType && !v && o.match.ID.test(w[0]) && !o.match.ID.test(w[w.length - 1]) && (n = m.find(w.shift(), d, v), 
            d = n.expr ? m.filter(n.expr, n.set)[0] : n.set[0]), d) for (n = f ? {
                expr: w.pop(),
                set: s(f)
            } : m.find(w.pop(), 1 !== w.length || "~" !== w[0] && "+" !== w[0] || !d.parentNode ? d : d.parentNode, v), 
            j = n.expr ? m.filter(n.expr, n.set) : n.set, w.length > 0 ? k = s(j) : u = !1; w.length; ) q = w.pop(), 
            r = q, o.relative[q] ? r = w.pop() : q = "", null == r && (r = d), o.relative[q](k, r, v); else k = w = [];
            if (k || (k = j), k || m.error(q || b), "[object Array]" === g.call(k)) if (u) if (d && 1 === d.nodeType) for (t = 0; null != k[t]; t++) k[t] && (k[t] === !0 || 1 === k[t].nodeType && m.contains(d, k[t])) && e.push(j[t]); else for (t = 0; null != k[t]; t++) k[t] && 1 === k[t].nodeType && e.push(j[t]); else e.push.apply(e, k); else s(k, e);
    ...
    f.fn.extend({
        find: function(a) {
            ...
            for (c = 0, d = this.length; d > c; c++) if (g = e.length, f.find(a, this[c], e), 
            c > 0) for (h = g; h < e.length; h++) for (i = 0; g > i; i++) if (e[i] === e[h]) {
                e.splice(h--, 1);
                break;
            }
            return e;
        ...
        f.fn[a] = function(c, d) {
            ...
            return L.test(a) || (d = c), d && "string" == typeof d && (e = f.filter(d, e)), 
    ...
    f.fn.extend({
        ...
        html: function(a) {
            return f.access(this, function(a) {
                ...
                if (!("string" != typeof a || ba.test(a) || !f.support.leadingWhitespace && X.test(a) || bg[(Z.exec(a) || [ "", "" ])[1].toLowerCase()])) {
                    a = a.replace(Y, "<$1></$2>");
                    try {
                        for (;e > d; d++) c = this[d] || {}, 1 === c.nodeType && (f.cleanData(c.getElementsByTagName("*")), 
                        c.innerHTML = a);
                        c = 0;
                    } catch (g) {}
                }
        ...
        var e, g, h, i, j = a[0];
        return b && b[0] && (i = b[0].ownerDocument || b[0]), i.createDocumentFragment || (i = c), 
        1 === a.length && "string" == typeof j && j.length < 512 && i === c && "<" === j.charAt(0) && !bb.test(j) && (f.support.checkClone || !bd.test(j)) && (f.support.html5Clone || !bc.test(j)) && (g = !0, 
        ...
        clone: function(a, b, c) {
            ...
            if (!(f.support.noCloneEvent && f.support.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || f.isXMLDoc(a))) for (bk(a, h), 
            d = bl(a), e = bl(h), g = 0; d[g]; ++g) e[g] && bk(d[g], e[g]);
        ...
        clean: function(a, b, d, e) {
            ...
            for (var l, k = 0; null != (l = a[k]); k++) if ("number" == typeof l && (l += ""), 
            l) {
                if ("string" == typeof l) if (_.test(l)) {
                    l = l.replace(Y, "<$1></$2>");
                    var r, m = (Z.exec(l) || [ "", "" ])[1].toLowerCase(), n = bg[m] || bg._default, o = n[0], p = b.createElement("div"), q = bh.childNodes;
                    for (b === c ? bh.appendChild(p) : U(b).appendChild(p), p.innerHTML = n[1] + l + n[2]; o--; ) p = p.lastChild;
                    if (!f.support.tbody) {
                        var s = $.test(l), t = "table" !== m || s ? "<table>" !== n[1] || s ? [] : p.childNodes : p.firstChild && p.firstChild.childNodes;
                ...
                var u;
                if (!f.support.appendChecked) if (l[0] && "number" == typeof (u = l.length)) for (i = 0; u > i; i++) bn(l[i]); else bn(l);
                l.nodeType ? j.push(l) : j = f.merge(j, l);
            }
            if (d) for (g = function(a) {
                return !a.type || be.test(a.type);
            }, k = 0; j[k]; k++) if (h = j[k], e && f.nodeName(h, "script") && (!h.type || be.test(h.type))) e.push(h.parentNode ? h.parentNode.removeChild(h) : h); else {
                if (1 === h.nodeType) {
    ...
    var by, bz, bA, bp = /alpha\([^)]*\)/i, bq = /opacity=([^)]*)/, br = /([A-Z]|^ms)/g, bs = /^[\-+]?(?:\d*\.)?\d+$/i, bt = /^-?(?:\d*\.)?\d+(?!px)[^\d\s]+$/i, bu = /^([\-+])=([\-+.\de]+)/, bv = /^margin/, bw = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    ...
    f.fn.css = function(a, c) {
        ...
        style: function(a, c, d, e) {
            if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
                ...
                if (h = typeof d, "string" === h && (g = bu.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(f.css(a, c)), 
                h = "number"), null == d || "number" === h && isNaN(d)) return;
        ...
        css: function(a, c, d) {
            var e, g;
            return c = f.camelCase(c), g = f.cssHooks[c], c = f.cssProps[c] || c, "cssFloat" === c && (c = "float"), 
        ...
        return b = b.replace(br, "-$1").toLowerCase(), (d = a.ownerDocument.defaultView) && (e = d.getComputedStyle(a, null)) && (c = e.getPropertyValue(b), 
        ...
        c = e.width, h.width = g), c;
    }), c.documentElement.currentStyle && (bA = function(a, b) {
        var c, d, e, f = a.currentStyle && a.currentStyle[b], g = a.style;
        return null == f && g && (e = g[b]) && (f = e), bt.test(f) && (c = g.left, d = a.runtimeStyle && a.runtimeStyle.left, 
        d && (a.runtimeStyle.left = a.currentStyle.left), g.left = "fontSize" === b ? "1em" : f, 
        f = g.pixelLeft + "px", g.left = c, d && (a.runtimeStyle.left = d)), "" === f ? "auto" : f;
        ...
        set: function(a, b) {
            ...
            c.zoom = 1, b >= 1 && "" === f.trim(g.replace(bp, "")) && (c.removeAttribute("filter"), 
            d && !d.filter) || (c.filter = bp.test(g) ? g.replace(bp, e) : g + " " + e);
        }
    }), f(function() {
    ...
    var bU, bV, bC = /%20/g, bD = /\[\]$/, bE = /\r?\n/g, bF = /#.*$/, bG = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm, bH = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, bI = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, bJ = /^(?:GET|HEAD)$/, bK = /^\/\//, bL = /\?/, bM = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, bN = /^(?:select|textarea)/i, bO = /\s+/, bP = /([?&])_=[^&]*/, bQ = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, bR = f.fn.load, bS = {}, bT = {}, bW = [ "*/" ] + [ "*" ];
    try {
        bU = e.href;
    } catch (bX) {
        ...
        ajax: function(a, c) {
            function w(a, c, l, m) {
                if (2 !== s) {
                    ...
                    var o, r, u, y, z, w = c, x = l ? ca(d, v, l) : b;
                    if (a >= 200 && 300 > a || 304 === a) if (d.ifModified && ((y = v.getResponseHeader("Last-Modified")) && (f.lastModified[k] = y), 
                    (z = v.getResponseHeader("Etag")) && (f.etag[k] = z)), 304 === a) w = "notmodified", 
                    o = !0; else try {
            ...
            null == d.crossDomain && (r = bQ.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] == bV[1] && r[2] == bV[2] && (r[3] || ("http:" === r[1] ? 80 : 443)) == (bV[3] || ("http:" === bV[1] ? 80 : 443)))), 
            d.data && d.processData && "string" != typeof d.data && (d.data = f.param(d.data, d.traditional)), 
            bZ(bS, d, c, v), 2 === s) return !1;
            if (t = d.global, d.type = d.type.toUpperCase(), d.hasContent = !bJ.test(d.type), 
            t && 0 === f.active++ && f.event.trigger("ajaxStart"), !d.hasContent && (d.data && (d.url += (bL.test(d.url) ? "&" : "?") + d.data, 
            delete d.data), k = d.url, d.cache === !1)) {
    ...
    f.ajaxSetup({
        ...
        if ("jsonp" === b.dataTypes[0] || b.jsonp !== !1 && (cd.test(b.url) || e && cd.test(b.data))) {
            ...
            return b.jsonp !== !1 && (j = j.replace(cd, l), b.url === j && (e && (k = k.replace(cd, l)), 
        ...
        if (!c.crossDomain || f.support.cors) {
            ...
            return {
                send: function(e, g) {
                    ...
                    c.xhrFields) for (j in c.xhrFields) h[j] = c.xhrFields[j];
                    ...
                    h.send(c.hasContent && c.data || null), d = function(a, e) {
                        var j, k, l, m, n;
                        try {
                            if (d && (e || 4 === h.readyState)) if (d = b, i && (h.onreadystatechange = f.noop, 
                            ce && delete cg[i]), e) 4 !== h.readyState && h.abort(); else {
                        ...
                        m && g(j, k, m, l);
                    }, c.async && 4 !== h.readyState ? (i = ++cf, ce && (cg || (cg = {}, f(a).unload(ce)), 
                    cg[i] = d), h.onreadystatechange = d) : d();
                },
                abort: function() {
                    d && d(0, 1);
                }
    ...
    var ck, cl, co, cq, cj = {}, cm = /^(?:toggle|show|hide)$/, cn = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, cp = [ [ "height", "marginTop", "marginBottom", "paddingTop", "paddingBottom" ], [ "width", "marginLeft", "marginRight", "paddingLeft", "paddingRight" ], [ "opacity" ] ];
    f.fn.extend({
        show: function(a, b, c) {
            var d, e;
            if (a || 0 === a) return this.animate(ct("show", 3), a, b, c);
            for (var g = 0, h = this.length; h > g; g++) d = this[g], d.style && (e = d.style.display, 
            !f._data(d, "olddisplay") && "none" === e && (e = d.style.display = ""), ("" === e && "none" === f.css(d, "display") || !f.contains(d.ownerDocument.documentElement, d)) && f._data(d, "olddisplay", cu(d.nodeName)));
        ...
        hide: function(a, b, c) {
            ...
            for (var d, e, g = 0, h = this.length; h > g; g++) d = this[g], d.style && (e = f.css(d, "display"), 
            "none" !== e && !f._data(d, "olddisplay") && f._data(d, "olddisplay", e));
        ...
        animate: function(a, b, c, d) {
            function g() {
                ...
                var g, h, i, j, k, l, m, n, o, p, q, b = f.extend({}, e), c = 1 === this.nodeType, d = c && f(this).is(":hidden");
                ...
                for (g in a) {
                    if (h = a[g], f.isArray(h) ? (b.animatedProperties[g] = h[1], h = a[g] = h[0]) : b.animatedProperties[g] = b.specialEasing && b.specialEasing[g] || b.easing || "swing", 
                    "hide" === h && d || "show" === h && !d) return b.complete.call(this);
                ...
                for (i in a) j = new f.fx(this, b, i), h = a[i], cm.test(h) ? (q = f._data(this, "toggle" + i) || ("toggle" === h ? d ? "show" : "hide" : 0), 
                q ? (f._data(this, "toggle" + i, "show" === q ? "hide" : "show"), j[q]()) : j[h]()) : (m = cn.exec(h), 
                n = j.cur(), m ? (o = parseFloat(m[2]), p = m[3] || (f.cssNumber[i] ? "" : "px"), 
                "px" !== p && (f.style(this, i, (o || 1) + p), n = (o || 1) / j.cur() * n, f.style(this, i, n + p)), 
        ...
        stop: function(a, c, d) {
            ...
            this.each(function() {
                ...
                if (d || f._unmark(!0, this), null == a) for (b in g) g[b] && g[b].stop && b.indexOf(".run") === b.length - 4 && h(this, g, b); else g[b = a + ".run"] && g[b].stop && h(this, g, b);
    ...
    cv = "getBoundingClientRect" in c.documentElement ? function(a, b, c, d) {
        ...
        k -= a.scrollTop, l -= a.scrollLeft, a === e && (k += a.offsetTop, l += a.offsetLeft, 
        f.support.doesNotAddBorder && (!f.support.doesAddBorderForTableAndCells || !cw.test(a.nodeName)) && (k += parseFloat(d.borderTopWidth) || 0, 
        l += parseFloat(d.borderLeftWidth) || 0), g = e, e = a.offsetParent), f.support.subtractsBorderForOverflowNotVisible && "visible" !== d.overflow && (k += parseFloat(d.borderTopWidth) || 0, 
        l += parseFloat(d.borderLeftWidth) || 0), j = d;
        return ("relative" === j.position || "static" === j.position) && (k += h.offsetTop, 
        l += h.offsetLeft), f.support.fixedPosition && "fixed" === j.position && (k += Math.max(c.scrollTop, h.scrollTop), 
        ...
        position: function() {
            ...
            return c.top -= parseFloat(f.css(a, "marginTop")) || 0, c.left -= parseFloat(f.css(a, "marginLeft")) || 0, 
        ...
        f.fn[a] = function(e) {
            return f.access(this, function(a, e, g) {
                var h = cy(a);
                return g === b ? h ? c in h ? h[c] : f.support.boxModel && h.document.documentElement[e] || h.document.body[e] : a[e] : (h ? h.scrollTo(d ? f(h).scrollLeft() : g, d ? g : f(h).scrollTop()) : a[e] = g, 
                void 0);
        ...
        f.fn["inner" + a] = function() {
            ...
            return f.access(this, function(a, c, h) {
                var i, j, k, l;
                return f.isWindow(a) ? (i = a.document, j = i.documentElement[d], f.support.boxModel && j || i.body && i.body[d] || j) : 9 === a.nodeType ? (i = a.documentElement, 
                i[d] >= i[e] ? i[d] : Math.max(a.body[e], i[e], a.body[g], i[g])) : h === b ? (k = f.css(a, c), 
                l = parseFloat(k), f.isNumeric(l) ? l : k) : (f(a).css(c, h), void 0);
    ...
    var Model = Backbone.Model = function(attributes, options) {
        ...
        options.parse && (attrs = this.parse(attrs, options) || {}), options._attrs || (options._attrs = attrs), 
    ...
    _.extend(Collection.prototype, Events, {
        ...
        set: function(models, options) {
            ...
            var i, l, model, attrs, existing, sort, at = options.at, sortable = this.comparator && null == at && options.sort !== !1, sortAttr = _.isString(this.comparator) ? this.comparator : null, toAdd = [], toRemove = [], modelMap = {}, add = options.add, merge = options.merge, remove = options.remove, order = !sortable && add && remove ? [] : !1;
            for (i = 0, l = models.length; l > i; i++) (model = this._prepareModel(attrs = models[i], options)) && ((existing = this.get(model)) ? (remove && (modelMap[existing.cid] = !0), 
            merge && (attrs = attrs === model ? model.attributes : options._attrs, existing.set(attrs, options), 
            sortable && !sort && existing.hasChanged(sortAttr) && (sort = !0))) : add && (toAdd.push(model), 
            model.on("all", this._onModelEvent, this), this._byId[model.cid] = model, null != model.id && (this._byId[model.id] = model)), 
            order && order.push(existing || model), delete options._attrs);
            if (remove) {
            ...
            if ((toAdd.length || order && order.length) && (sortable && (sort = !0), this.length += toAdd.length, 
            null != at ? splice.apply(this.models, [ at, 0 ].concat(toAdd)) : (order && (this.models.length = 0), 
            push.apply(this.models, order || toAdd))), sort && this.sort({
                silent: !0
            }), options.silent) return this;
            for (i = 0, l = toAdd.length; l > i; i++) (model = toAdd[i]).trigger("add", model, this, options);
            return (sort || order && order.length) && this.trigger("sort", this, options), this;
        },
...
PxwrkLib = function() {
    function PxwrkLib() {}
    return PxwrkLib.prototype.functionLog = function(name) {
        return name;
    }, PxwrkLib.prototype.valueHasChanged = function() {
        var latestValue;
        return latestValue = [], function(value, id) {
            var result;
            return value === latestValue[id] ? result = !1 : (latestValue[id] = value, result = !0), 
            result;
        };
    }(), PxwrkLib;
}();

var PxwrkViewLib, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    function ctor() {
        this.constructor = child;
    }
...
PxwrkViewLib = function(_super) {
    function PxwrkViewLib() {
        return _ref = PxwrkViewLib.__super__.constructor.apply(this, arguments);
    }
    return __extends(PxwrkViewLib, _super), PxwrkViewLib.prototype.itemDetailTmpl = function() {
        var result;
...
var Item, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    function ctor() {
        this.constructor = child;
    }
    for (var key in parent) __hasProp.call(parent, key) && (child[key] = parent[key]);
...
Item = function(_super) {
    function Item() {
        return _ref = Item.__super__.constructor.apply(this, arguments);
    }
    return __extends(Item, _super), Item.prototype.defaults = {
        id: "Fehler! ID fehlt"
    }, Item.prototype.initialize = function() {
        if (!this.get("manisch")) throw new Error("manisch translation is missing");
        if (!this.get("german")) throw new Error("german translation is missing");
    }, Item;
}(Backbone.Model);

var ItemView, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    function ctor() {
        this.constructor = child;
    }
    for (var key in parent) __hasProp.call(parent, key) && (child[key] = parent[key]);
...
ItemView = function(_super) {
    function ItemView() {
        return _ref = ItemView.__super__.constructor.apply(this, arguments);
    }
    return __extends(ItemView, _super), ItemView.prototype.tagName = "li", ItemView.prototype.initialize = function() {
        if (_.bindAll(this), !this.model) throw new Error("model is required");
        if ("Item" !== this.model.constructor.name) throw new Error("model is not an instance of Item");
    }, ItemView.prototype.events = {
        click: "showItemDetail"
    }, ItemView.prototype.render = function() {
        return pxwrk.functionLog("ItemView.render()"), this.itemTmpl ? jQuery(this.el).html(_.template(this.itemTmpl, this.model.toJSON())) : jQuery(this.el).html("Error: Missing Template"), 
        this;
    }, ItemView.prototype.unrender = function() {
        return pxwrk.functionLog("ItemView.unrender()"), this.remove(), this;
    }, ItemView.prototype.renderItemDetailView = function() {
        var itemDetailView;
        return itemDetailView = new ItemDetailView({
            model: this.model
...
var ItemDetailView, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    function ctor() {
        this.constructor = child;
    }
    for (var key in parent) __hasProp.call(parent, key) && (child[key] = parent[key]);
...
ItemDetailView = function(_super) {
    function ItemDetailView() {
        return _ref = ItemDetailView.__super__.constructor.apply(this, arguments);
    }
    var fadeDuration;
    return __extends(ItemDetailView, _super), ItemDetailView.prototype.tagName = "div", 
    ItemDetailView.prototype.id = "item-detail-view", ItemDetailView.prototype.events = {
        click: "unrenderCheck",
        "click a": "unrender",
        "click .close": "unrender"
    }, fadeDuration = 0, ItemDetailView.prototype.itemHtml = function() {
        return _.template(this.itemTmpl, this.model.toJSON());
    }, ItemDetailView.prototype.viewHtml = function() {
        var item;
        return item = this.model ? _.template(this.itemDetailTmpl, {
            content: this.itemHtml(),
            item: this.model.toJSON()
        }) : _.template(this.itemDetailTmpl, {
        ...
        var _this = this;
        return _.bindAll(this), jQuery(document).on("keyup", function(event) {
            return 27 === event.keyCode ? _this.unrender() : void 0;
        });
    }, ItemDetailView.prototype.render = function() {
        return jQuery(this.el).html(this.viewHtml()), this;
    }, ItemDetailView.prototype.show = function() {
        var url;
        return url = router.getNewUrl(), this.model && (url += "item/" + this.model.toJSON().id), 
        router.navigate(url, {
            trigger: !1
        }), this.$el.css("display", "none"), jQuery("body").append(this.el), this.$el.fadeIn(fadeDuration), 
        this.$el.find(".button").focus(), this;
    }, ItemDetailView.prototype.unrenderCheck = function(event) {
        return "item-detail-view" === event.target.id ? this.unrender(event) : void 0;
    }, ItemDetailView.prototype.unrender = function() {
        return jQuery(document).off("keyup"), this.$el.fadeOut(fadeDuration, function() {
            var url;
            return this.remove(), url = router.getNewUrl(), router.navigate(url, {
                trigger: !1
            });
        });
    }, ItemDetailView;
...
var List, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    function ctor() {
        this.constructor = child;
    }
    for (var key in parent) __hasProp.call(parent, key) && (child[key] = parent[key]);
...
List = function(_super) {
    function List() {
        return _ref = List.__super__.constructor.apply(this, arguments);
    }
    return __extends(List, _super), List.prototype.model = Item, List.prototype.url = "/translations", 
    List.prototype.fetch = function(options) {
        return options = options || {}, options.async = !1, List.__super__.fetch.call(this, options);
    }, List.prototype.category = function(categoryName) {
        var itemByCategory, result;
        return "alle" === categoryName ? result = this : (itemByCategory = function(item) {
            return _.contains(item.get("category"), categoryName);
        }, result = new List(), result.add(this.filter(itemByCategory))), result;
    }, List.prototype.search = function(param) {
        var byInput, filtered;
        return param ? (byInput = function(element) {
            var attributes, pattern;
            return attributes = element.toJSON(), pattern = RegExp(param.toLowerCase()), attributes.german.toLowerCase().match(pattern) || attributes.manisch.toLowerCase().match(pattern);
        }, filtered = new List(this.filter(byInput))) : this;
    }, List;
}(Backbone.Collection);

var ListView, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    function ctor() {
        this.constructor = child;
    }
    for (var key in parent) __hasProp.call(parent, key) && (child[key] = parent[key]);
...
ListView = function(_super) {
    function ListView() {
        return _ref = ListView.__super__.constructor.apply(this, arguments);
    }
    return __extends(ListView, _super), ListView.prototype.tagName = "ul", ListView.prototype.visibleItems = new List(), 
    ListView.prototype.getFilteredList = function(params) {
        var items;
        return this.unrender(), items = translations.category(params.category).search(params.search), 
        this.visibleItems.reset(items.toJSON()), this;
    }, ListView.prototype.getClassName = function() {
        var itemsCounter, latestTranslation, translationsCounter;
        return latestTranslation = !1, translationsCounter = 0, itemsCounter = 0, function(item, amount) {
            var result;
            return latestTranslation.german === item.toJSON().german ? result = "same-german" : latestTranslation.manisch === item.toJSON().manisch ? result = "same-manisch" : (result = "", 
            translationsCounter++), result += 0 === translationsCounter % 2 ? " even" : " odd", 
            itemsCounter++, itemsCounter === amount ? (translationsCounter = 0, itemsCounter = 0, 
            latestTranslation = !1) : latestTranslation = item.toJSON(), result;
        };
        ...
        var el;
        return el = jQuery("#bottom-list-info"), el.hasClass("inactive") ? void 0 : el.addClass("inactive");
    }, ListView.prototype.render = function() {
        return pxwrk.functionLog("render()"), this.deactivateInfo(), this.appendItems().show(), 
        this;
...
var AppView, _ref, __bind = function(fn, me) {
    return function() {
...
AppView = function(_super) {
    function AppView() {
        return this.loadListInBackground = __bind(this.loadListInBackground, this), _ref = AppView.__super__.constructor.apply(this, arguments);
    }
    var isColored;
    return __extends(AppView, _super), AppView.prototype.tmpl = function() {
        var result;
        return result = "", jQuery.ajax({
    ...
    }(), AppView.prototype.className = "page-wrap", AppView.prototype.events = {
        "keyup #search": "performSearch",
        "change #search": "performSearch",
        "submit #searchform": "preventSubmit",
        "keyup #primary": "keyNav"
    }, AppView.prototype.listView = new ListView(), AppView.prototype.render = function() {
        return pxwrk.functionLog("AppView.render()"), this.tmpl ? jQuery(this.el).html(this.tmpl) : jQuery(this.el).html("Error: Missing Template"), 
        this;
    }, AppView.prototype.show = function() {
        return pxwrk.functionLog("AppView.render()"), jQuery("body#manischapp").html(this.el), 
        this;
    }, AppView.prototype.navHeight = function() {
        var _ref1;
        return null != (_ref1 = jQuery("#secondary .top-bar").offset()) ? _ref1.top : void 0;
    }, AppView.prototype.keyNav = function(event) {
        var el, url;
        switch (console.log(this.$el.find("#" + event.target.id).prev()), el = this.$el.find("#" + event.target.id), 
        event.keyCode) {
          case 38:
            el = el.prev(), url = el.attr("href"), router.navigate(url, {
                trigger: !0
            }), el.focus(), console.log("hoch");
            break;

          case 40:
            el = el.next(), url = el.attr("href"), router.navigate(url, {
                trigger: !0
            }), el.focus(), console.log("runter");
            break;
    ...
    }, isColored = !1, AppView.prototype.preventSubmit = function(event) {
        var backgroundColor, elements;
        return event.preventDefault(), isColored ? void 0 : (isColored = !0, elements = jQuery("#itemview .german"), 
        jQuery.merge(elements, jQuery("#itemview .manisch")), backgroundColor = jQuery(elements[0]).css("color"), 
        elements.css("color", "#070"), setTimeout(function() {
            return elements.css({
                color: backgroundColor
            }), isColored = !1;
        }, 500));
    }, AppView.prototype.performSearch = function() {
        return router.navigate(router.getNewUrl(), {
            trigger: !0
        });
    }, AppView.prototype.setFocusToFirstInput = function() {}, AppView.prototype.performScrollCheck = function() {
        var currentNavHeight;
        if (currentNavHeight = this.navHeight(), jQuery("body").hasClass("fixsearch")) {
            if (currentNavHeight && jQuery(window).scrollTop() < currentNavHeight) return jQuery("body").removeClass("fixsearch");
        } else if (currentNavHeight && jQuery(window).scrollTop() > currentNavHeight) return jQuery("body").addClass("fixsearch");
    }, AppView.prototype.listRequest = function(params) {
        return pxwrk.functionLog("listRequest()"), jQuery("#search").val() !== params.search && jQuery("#search").val(params.search), 
        pxwrk.valueHasChanged(params.search, "search") || pxwrk.valueHasChanged(params.category, "category") ? this.listView.getFilteredList(params) : void 0;
    }, AppView.prototype.clearSearchInput = function() {
        return jQuery("#search").val("");
    }, AppView.prototype.setRandomParams = function() {
        var category, params;
        return category = router.currentCat.get() ? router.currentCat.get() : "alle", params = {
            category: category,
            search: "",
            id: _.random(1, translations.length).toString()
        };
    }, AppView.prototype.loadListInBackground = function(params) {
        return router.currentCat.get() ? void 0 : (this.listRequest(params), this.listView.render());
    }, AppView.prototype.randomItemRequest = function() {
        var params;
        return params = this.setRandomParams(), this.clearSearchInput(), this.loadListInBackground(params), 
        this.showItemDetail(params);
    }, AppView.prototype.showItemDetail = function(params) {
        var item, itemDetailView, items;
        return items = translations.category("alle").search(""), item = items.findWhere({
            id: params.id
        ...
        var _this = this;
        return pxwrk.functionLog("initialize()"), _.bindAll(this), this.render().show(), 
        this.setFocusToFirstInput(), jQuery(window).on("scroll", function() {
            return _this.performScrollCheck();
        }), jQuery(window).on("resize", function() {
            return jQuery("body").removeClass("fixsearch"), _this.performScrollCheck();
        });
    }, AppView;
}(PxwrkViewLib);

var Router, _ref, __hasProp = {}.hasOwnProperty, __extends = function(child, parent) {
    function ctor() {
        this.constructor = child;
    }
    for (var key in parent) __hasProp.call(parent, key) && (child[key] = parent[key]);
...
Router = function(_super) {
    function Router() {
        return _ref = Router.__super__.constructor.apply(this, arguments);
    }
    return __extends(Router, _super), Router.prototype.routes = {
        ...
        return app.$el.find("#primary .active").removeClass("active"), app.$el.find("#" + params.category + "-btn").addClass("active");
    }, Router.prototype.getNewUrl = function() {
        var url;
        return pxwrk.functionLog("getNewUrl"), url = "", this.currentCat.get() && (url += "cat/" + this.currentCat.get() + "/"), 
        jQuery("#search").val() && (url += "search/" + jQuery("#search").val() + "/"), url;
    }, Router.prototype.showFilteredList = function(category, search) {
        var params;
        return null == category && (category = "alle"), null == search && (search = ""), 
        params = {
            category: category,
            search: search
        }, this.beforeNavigate(params), pxwrk.functionLog("showFilteredList"), this.currentCat.set(params.category), 
        app.listView.unrender(), app.listRequest(params), app.listView.render(), app;
        ...
        return pxwrk.functionLog("showRandomItems"), app.randomItemRequest();
        ...
        return params = {
            ...
            search: search,
            id: id
        }, this.beforeNavigate(params), this.showFilteredList(category, search), app.showItemDetail(params);
    }, Router;
}(Backbone.Router);

var app, pxwrk, router, translations;

pxwrk = new PxwrkLib(), translations = new List(), translations.fetch({
    error: function() {},
    success: function() {}
}), app = new AppView(), app.render(), router = new Router(), Backbone.history.start();